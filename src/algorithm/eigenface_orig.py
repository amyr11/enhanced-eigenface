...
class Eigenface:
    ...
    def predict(self, X_unknown):
        ...
        X_unknown_weights = Eigenface.get_weights(
        ...
        projection_distances = Eigenface.get_projection_distances(
    ...
    def _calculate_weight_space(self):
        ...
        self._avg_X_weights, self._y_avg = Eigenface.get_averaged_weight_space(
